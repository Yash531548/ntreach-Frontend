...
const ProviderProfile = () => {
  ...
  const auth = useAuthProviderUser();
  ...
  const getProfile = useCallback(async () => {
    try {
      ...
      setProfile({
        ...
        clinicAddress: response.data?.service_provider?.clinic_address || '',
        services: response.data?.service_provider?.service_names.map(service => ({
  ...
  const updateProfile = useCallback(async () => {
    try {
      await api.post('/sp/update_profile', {
      ...
      <div className="w-full md:max-w-3xl mt-12">
        <div className="w-full p-2 mx-auto space-y-14">
          ...
          <div className="flex flex-col items-center space-y-6">
            ...
            <form
              className="w-full max-w-2xl space-y-4 p-2"
              onSubmit={e => {
                e.preventDefault();
                updateProfile();
              }}
