...
//     return (
//         <div className="container w-full lg:w-[95%] xl:max-w-[1000px] 2xl:max-w-[1250px]    mx-auto  mt-6 xl:min-h-[calc(100vh-64px-60px)]  px-2 sm:px-6  " >
//             {/* <div className="grid grid-cols-12 gap-6  border border-black "> */}
//             <div className="relative">
//                 <div className="flex ">
//                     <div className="rounded-[2rem] shadow-lg   xl:min-h-[500px] grid grid-cols-12 gap-6 pt-8 p-0 pr-8 mr-4 w-[80%]">
...
//                 <div className="absolute bottom-0 right-0 lg:right-0 lg:bottom-10  gap-4 rounded-full  cursor-pointer bg-gray-200 shadow-lg">
...
export default function Questionnaire() {
    ...
    return (
        <div className="container relative w-full  lg:w-[95%] xl:max-w-[1000px] 2xl:max-w-[1250px] mx-auto mt-6 mb-6 px-2 sm:px-6">

            <div className="relative">
                {/* ------------------ MOBILE + TABLET HEADER ------------------ */}
                <div className="block lg:hidden text-center mb-4">
                    <h2
                        className="text-[28px] md:text-3xl text-[#1475A1] font-normal"
                        style={{ fontFamily: "Sofia Pro", fontWeight: 400 }}
                    >
                ...
                <div className="flex">
                    ...
                    <div className="hidden lg:grid grid-cols-12 gap-6 rounded-[2rem] shadow-lg pt-8 p-0 pr-8 lg:pr-2 xl:pr-8 mr-4 lg:w-[78%] xl:w-[80%]">
                        {/* Left Section */}
                        <div className="lg:col-span-5 xl:col-span-4 flex flex-col items-start justify-start gap-16 bg-[#FCFCFC] h-full rounded-l-[2rem]">
                            <h2
                                className="text-4xl leading-tight text-[#1475A1] font-normal mx-auto lg:text-center "
                                style={{ fontFamily: "Sofia Pro", fontWeight: 400 }}
                            >
                                Tell us about <br /> Yourself
                            </h2>
