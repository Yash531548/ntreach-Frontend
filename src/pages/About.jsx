    ...
    return (
        <div style={{ fontFamily: "Sofia Pro", fontWeight: 400 }}>
            <div className='container w-full mx-auto flex items-center px-4 md:mb-8 sm:px-4 lg:px-10 xl:px-0 mt-9 2xl:ml-0' >
                {/* Section 1 */}
                <main className='container  max-w-[1200px] flex flex-col md:flex-row mx-auto lg:max-w-[850px] xl:max-w-[1100px] gap-10 md:gap-3 md:px-8 md:mt-8 '>
                    <section>
                        <header className='text-3xl lg:text-4xl xl:text-[40px] '>
                    ...
                    <article className=' flex justify-center items-center' style={{ fontFamily: "Sofia Pro", fontWeight: 400 }}>
                        <div className='relative z-1 md:max-h-[320px] xl:max-h-[330px]  md:max-w-[380px] xl:max-w-[400px] shadow-[0px_0px_45px_-1px_rgba(0,0,0,0.15)] ' style={{borderRadius:"30px"}}>
...
//                     </section>
//                     <article className=' flex justify-center items-center' style={{ fontFamily: "Sofia Pro", fontWeight: 400 }}>
//                         {/* <main className='w-full md:max-w-[380px] xl:max-w-[400px] shadow-[0px_0px_45px_-1px_rgba(0,0,0,0.15)] border-4 border-[#323FF7]  text-black bg-[#DAF3FF] flex flex-col justify-center items-center gap-2  rounded-4xl h-full md:max-h-[320px] xl:max-h-[330px] py-12 px-4 md:py-0 lg:px-12 xl:mt-16'> */}
//                         <main className=' w-full md:max-w-[380px] xl:max-w-[400px] shadow-[0px_0px_45px_-1px_rgba(0,0,0,0.15)] border-none  text-black bg-[#DAF3FF] flex flex-col justify-center items-center gap-2  rounded-4xl h-full md:max-h-[320px] xl:max-h-[330px] py-12 px-4 md:py-0 lg:px-12 xl:mt-16 relative after:absolute after:inset-0 after:-m-[0.2rem] after:rounded-4xl  after:bg-[linear-gradient(111.19deg,#323FF7_3.01%,#33AEE5_97.71%)] after:-z-1'>
//                             <img src={VectorAbout} alt="IndiaMap.png" className='w-18 h-18' />
//                             <p className='text-xl md:text-2xl font-medium'>Connecting India</p>
//                             <p className='text-center text-lg font-light'>Building bridges to sexual healthcare across every state and union territory</p>
//                         </main>
//                     </article>
//                 </main>
//             </div>
