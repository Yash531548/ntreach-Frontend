...
const languages = [
  ...
  { code: 'mwr', label: 'Marwari (Marwadi)', short: 'MWR' },
    ...
    <>
      <div className="relative inline-block ">
        <select
          ...
          className="border border-[#0B1E2A] text-[rgba(11,30,42,0.9)] font-medium tracking-normal w-20 rounded-full px-4 lg:px-2 lg:pr-5 xl:pr-5 xl:px-3 py-0.5 lg:py-1  focus:outline-none focus:ring-2 focus:ring-blue-400 font-redhat appearance-none text-sm lg:text-xs"
        >
