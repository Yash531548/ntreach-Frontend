    ...
    return (
        <div className='rounded-r-4xl w-full border border-gray-300 border-l-0 shadow-sm pt-8 px-10'>
            <div className='flex  items-center justify-between gap-4'>
                ...
                <p className='text-[#0063B9] text-3xl' style={{ fontFamily: "Sofia Pro", fontWeight: 400 }}>My Results/Past Data</p>
                            ...
                            >
                                ...
                                <td className="px-4 py-3 rounded-r-4xl text-[#323FF7]">
                                    ...
                                    {report.reportType === "reupload" && (
                                        <span className="text-red-500 cursor-pointer hover:underline flex items-center gap-1 ml-[-12px] ">
