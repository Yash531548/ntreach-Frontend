...
//     const buttons = [
//         { label: "Book an HIV Test", action: "#" },
//         { label: "Start PrEP Consultation", action: "#" },
//         { label: "Talk to our Counsellor", action: "#" }
//     ];

//     return (
//         <div className=" flex flex-col gap-4 text-xl " style={{ fontFamily: 'Sofia Pro', fontWeight: 300 }}>
//             {buttons.map((button, index) => (
//                 <a
//                     key={index}
//                     href={button.action}
//                     className=" flex items-center justify-between shadow-xl hover:shadow-xl/20  pl-6 pr-2 py-[10px] border border-[#566AFF] bg-[linear-gradient(to_bottom,_#323FF7_0%,_#323FF7_20%,_#33AEE5_100%)] text-white rounded-full  min-w-[300px] max-w-[600px] sm:min-w-[250px] sm:max-w-[500px] "
//                 >
//                     {button.label}
...
//         setChecked(false); // reset checkbox each time
//         setShowModal(true);
//     };

//     // Handle proceed after checking box
//     const handleProceed = () => {
//         if (checked && selectedService) {
//             setShowModal(false);
//             navigate(selectedService.action); // go to login
//         }
//     };
...
//               pl-6 pr-2 py-[10px] border border-[#566AFF] cursor-pointer 
...
//                     <div className="bg-white border-[#2684AE] border-3 p-6 rounded-xl shadow-lg text-center w-[100%] max-w-md">
//                         {/* Custom Checkbox */}
...
//                             >
//                                 {checked && (
//                                     <img src={Arrowvector} alt="check" className="w-8 h-8" />
//                                 )}
//                             </div>
...
//                             className={`mt-6 px-6 py-2 rounded-full text-white font-medium cursor-pointer
