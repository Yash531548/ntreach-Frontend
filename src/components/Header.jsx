    ...
    return (
        <>
            <header className="bg-white container max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-12 flex items-center justify-between py-4 "  style={{ fontFamily: 'Sofia Pro' }}>
                ...
                {/* Desktop Navigation */}
                <nav className="hidden lg:block  xl:ml-[8%] " style={{ fontFamily: 'Sofia Pro', fontWeight: 400 }}>
                    <ul className="flex text-black  font-[400] text-xs  lg:text-[11px] xl:text-[13px] gap-3 xl:gap-6">
                        <li>
                            <NavLink
                                to="/"
                                className={({ isActive }) =>
